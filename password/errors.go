...
var (
	ErrBufferTooSmall        = errors.New("buffer is too small to hold the generated password")
	...
	ErrNoNonSymbolsInCharset = errors.New("found no non-symbol characters to fill the password beyond the requested symbol count")
